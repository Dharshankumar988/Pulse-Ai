...
settings = Settings(
    ...
    yolo_tumor_model_path=os.getenv("YOLO_TUMOR_MODEL_PATH", os.path.join(DEFAULT_MODELS_DIR, "tumor_model.pt")),
    yolo_kidney_stone_model_path=os.getenv("YOLO_KIDNEY_STONE_MODEL_PATH", os.path.join(DEFAULT_MODELS_DIR, "kidney_stone_model.pt")),
